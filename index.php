                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            ...
                            <div class="book-btn">
                                <a href="User/user_login.php" class="table-btn hvr-underline-from-center">Complaint Box Login</a>
                            </div>
                            <a href="#about">
                                <div class="mouse"></div>
                            </a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p>We have all wanted to enjoy good meals without feeling guilty or compromising on our health. But what are the options??
                        </p>
                    ...
                    <div class="footer-in-main">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <span style="background-color: #e75b1e;"><a href="User/user_login.php">Login to ask a question</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
