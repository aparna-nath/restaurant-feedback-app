...
<!--user session passed -->             <div align="left">
                        ...
                        <thead>
                            <tr>
                               ...
                               <th style="color: darkgreen;" scope="col">Picture</th>
                                ...
                                <th style="color: darkgreen;" scope="col" style="width: 200px;">Complaint</th>
                            </tr>
                        </thead>
                         <tbody>
  <?php
  ...
  $res=$ob->sql_query($sql);
   ...
   ?>
                           <tr>
                                ...
                                <td width="100" height="100"><img src="../images/<?php echo $r["meal_img"];?>" width="150" height="150"></td>
                                ...
                                <td>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item">
                                         <a href="complaint_enter.php?meal_id=<?php echo $r["meal_id"];?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" class="px-2 text-primary">Click Here</a>
                                          </li>
