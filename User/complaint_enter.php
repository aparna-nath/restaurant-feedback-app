...
<head>
    ...
    <!-- Site Metas -->
    <title>Enter the Complaint</title>
                ...
                <div class="row">
                    <div class="main-menu">
                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div align="right">
                          <a href="logout.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" style="background-color:#e75b1e">Log Out</a>
                        </div>
                            
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right" style="background-color: wheat;">
                                    <li><a href="welcome_user.php">Home</a></li>
                                    <li><a href="#menu">Meal Complaints</a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-menu">
                        <p>
                            ...
                            <form method="post" action="complaint_action.php" name="f1">
<?php
...
include('dbOperation.php');
  ...
  $results=$ob->sql_query($sql);
   while($r=mysqli_fetch_array($results))
   {
?>
<table width="200" border="1" align="center">
    <tr>
      <td colspan="2" bgcolor="orange">Meal Details</td>
    </tr>
    <tr>
      <td>Meal Name</td>
      <td><?php echo $r["meal_name"];?></td>
    </tr>
    ...
    <tr>
      <td>Meal Price</td>
      <td>
      <?php echo $r["meal_price"];?></td>
    </tr>
    <tr>
      <td>Complaint</td>
      <td>
        <textarea name="txtcomplaint" id="meal_comp"> </textarea>
     </td>
    </tr>
    <tr>
...
<input type="hidden" name="hid" value="<?php echo $eid;?>"> <!--set meal_id in hidden field-->
</form>
 <?php
}
?>
