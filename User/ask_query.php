                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right" style="background-color: wheat;">
                                    ...
                                    <li><a href="#footer">Ask Question</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <h2 class="ft-title color-white text-center"> Ask your question </h2>
                            <p>
                             <!-- form sarts here-->
                                <form method="post" action="ask_query_action.php" name="f1">
 
<table width="300" border="1" align="center">
    
    <tr>
      <td style="color: white;" >Question (no more than 200 words)</td>
      <td>
        <textarea name="question" id="txtquestion"></textarea>
    </tr> 
