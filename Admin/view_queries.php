...
<body>
                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right" style="background-color: wheat;">
                                    ...
                                    <li><a href="#query">Query History</a></li>
                    ...
                    <table class="table project-list-table table-nowrap align-middle table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th style="color: darkgreen;" scope="col">UserId</th>
                                <th style="color: darkgreen;" scope="col">Query</th>
                                <th style="color: darkgreen;" scope="col">Reply</th>
                                <th style="color: darkgreen;" scope="col" style="width: 200px;">Reply Here</th>
                            </tr>
                        </thead>
                         <tbody>
  <?php
  ...
  $ob=new dbOperation();
  $sql_select="select * from user_query";
  $res=$ob->sql_query($sql_select);
   ...
   ?>
                           <tr>
                                ...
                                <td><?php echo $r["user_id"];?></a></td>
                                <td><?php echo $r["query_post"];?></td>
                                <td><?php echo $r["query_reply"];?></td>
                              

                                <td>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item">
                                         <a href="reply_query.php?query_id=<?php echo $r["query_id"];?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Reply" class="px-2 text-primary"><i class="bx bx-pencil font-size-20"></i></a>
                                          </li>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <a href="view_queries.php " class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">General Q&A</a>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
