                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right" style="background-color: wheat;">
                                    ...
                                    <li><a href="view_queries.php">Query History</a></li>
                                    <li><a href="#query">Query Reply</a></li>
                                </ul>
                            </div>
                            <!-- end nav-collapse -->
                        </nav>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-menu">
                        <p>
                            ...
                            <form method="post" action="reply_query_action.php" name="f1">
                                <?php
                                    include("dbOperation.php");
                                    $obj=new dbOperation();

                                    $cid=$_GET['query_id'];
                                    $sql= "select * from user_query where query_id=$cid";
...
<table width="200" border="1" align="center">
    <tr>
      <td>Query</td>
      <td>
      <label><?php echo $row["query_post"];?></label>
      </td>
    </tr>
    <tr>
      <td>Post Reply</td>
      <td><textarea name="query_reply" id="txtreply"></textarea></td>
    </tr>
    
    <tr>
      <td colspan="2"><input type="submit" name="button" id="button" value="Update Query" /></td>
    </tr>
  </table>
  
<input type="hidden" name="hidid" value="<?php echo $cid;?>"><!--set id in hidden field-->
</form>
 <?php
}
?>
