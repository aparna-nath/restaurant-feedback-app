                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right" style="background-color: wheat;">
                                    ...
                                    <li><a href="view_all_complaints.php">Complaint History</a></li>
                                    <li><a href="#menu">Change Status</a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-menu">
                        <p>
                            ...
                            <form method="post" action="solve_complaints_action.php" name="f1">
                                <?php
                                    include("dbOperation.php");
                                    $obj=new dbOperation();

                                    $cid=$_GET['comp_id'];
                                    $sql= "select *from complaints where comp_id=$cid";
...
<table width="200" border="1" align="center">
    <tr>
      <td>Status</td>
      <td>
      <label><?php echo $row["comp_status"];?></label>
      </td>
    </tr>
    <tr>
      <td>Change Status</td>
    ...
    <tr>
      <td>Complaint</td>
      <td>
      <label>"<?php echo $row["comp_detail"];?>"</label>
      </td>
    </tr>
    <tr>
